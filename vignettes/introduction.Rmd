...
setwd("../test/badirate_analysis")

split_orthogroups("Orthogroups.GeneCount.csv", max_count = 40, og_path = "./badirate_orthogroups")
...
bd_path = "~/bin/badirate-1.35/"

branch_numbers(tree = "SpeciesTree.Ultrametric.tree",
               og = "Orthogroups.GeneCount.csv",
...
setup_table <- prepare_badirate(og_path = "./badirate_orthogroups/",
                                tree = "SpeciesTree.Ultrametric.tree",
...
After all the jobs finished, it is time to collect the important data from each files in the `./raw_outputs` directory.
...
setup_table <- readr::write_csv("./setup_table.csv")
...
```{r, eval = FALSE}
bd_extract_gain(best_models = best_models, results_dir = "./results")
